                ...
                <div class="card-body">
                    ...
                    <div class="multi-select-container" id="dataSubjectsContainer">
                        <div class="chips-container mb-2">
                            ...
                            ?>
                            <?php $__currentLoopData = $dataSubjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="tag-chip">
