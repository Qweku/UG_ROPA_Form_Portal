...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['code' => '404', 'stampColor' => 'var(--accent)', 'stampDark' => 'var(--accent-dark)']));
...
foreach (array_filter((['code' => '404', 'stampColor' => 'var(--accent)', 'stampDark' => 'var(--accent-dark)']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="error-illustration" aria-hidden="true">
    <svg viewBox="0 0 320 260" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(160 150) rotate(-12)" class="error-stamp">
            <circle cx="0" cy="0" r="58" fill="none" stroke="<?php echo e($stampColor); ?>" stroke-width="5"/>
            <circle cx="0" cy="0" r="48" fill="none" stroke="<?php echo e($stampColor); ?>" stroke-width="2"/>
            <text x="0" y="8" text-anchor="middle" font-family="'Instrument Sans', ui-sans-serif, sans-serif"
                  font-size="30" font-weight="800" fill="<?php echo e($stampColor); ?>" letter-spacing="1"><?php echo e($code); ?></text>
        </g>
    </svg>
</div>
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/errors/partials/error-illustration.blade.php ENDPATH**/ ?>