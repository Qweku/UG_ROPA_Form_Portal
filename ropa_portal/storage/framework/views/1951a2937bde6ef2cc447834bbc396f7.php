            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <select name="international_transfers[]" class="form-select" multiple size="6">
                        <option value="Kenya" <?php echo e(in_array('Kenya', $transfers) ? 'selected' : ''); ?>>🇰🇪 Kenya</option>
                        <option value="United Kingdom" <?php echo e(in_array('United Kingdom', $transfers) ? 'selected' : ''); ?>>🇬🇧 United Kingdom</option>
                        <option value="USA" <?php echo e(in_array('USA', $transfers) ? 'selected' : ''); ?>>🇺🇸 United States</option>
                        <option value="Germany" <?php echo e(in_array('Germany', $transfers) ? 'selected' : ''); ?>>🇩🇪 Germany</option>
                        <option value="South Africa" <?php echo e(in_array('South Africa', $transfers) ? 'selected' : ''); ?>>🇿🇦 South Africa</option>
                        <option value="India" <?php echo e(in_array('India', $transfers) ? 'selected' : ''); ?>>🇮🇳 India</option>
                        <option value="Netherlands" <?php echo e(in_array('Netherlands', $transfers) ? 'selected' : ''); ?>>🇳🇱 Netherlands</option>
                        <option value="Ireland" <?php echo e(in_array('Ireland', $transfers) ? 'selected' : ''); ?>>🇮🇪 Ireland</option>
                        <option value="Canada" <?php echo e(in_array('Canada', $transfers) ? 'selected' : ''); ?>>🇨🇦 Canada</option>
                        <option value="Australia" <?php echo e(in_array('Australia', $transfers) ? 'selected' : ''); ?>>🇦🇺 Australia</option>
                    </select>
