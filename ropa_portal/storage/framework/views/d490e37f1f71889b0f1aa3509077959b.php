            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor: pointer;" onclick="document.getElementById('breach-yes').click()">
                                <input class="form-check-input" type="radio" name="breach_occurred" value="1" id="breach-yes"
                                    <?php echo e(old('breach_occurred', $submission->breach_occurred) == '1' ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor: pointer;" onclick="document.getElementById('breach-no').click()">
                                <input class="form-check-input" type="radio" name="breach_occurred" value="0" id="breach-no"
                                    <?php echo e(old('breach_occurred', $submission->breach_occurred) == '0' ? 'checked' : ''); ?>>
                    ...
                    <div id="breach-section"
                        class="mt-4"
                        style="display: <?php echo e(old('breach_occurred', $submission->breach_occurred) == '1' ? 'block' : 'none'); ?>;">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="url" name="breach_link" class="form-control"
                                value="<?php echo e(old('breach_link', $submission->breach_link)); ?>"
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/ropa/steps/step13.blade.php ENDPATH**/ ?>