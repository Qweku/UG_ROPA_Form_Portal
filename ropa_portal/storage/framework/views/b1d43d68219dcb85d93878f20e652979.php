...
<input class="form-check-input" type="radio" name="data_source" value="individual" id="src-individual"
                                <?php echo e(($submission->data_source ?? '') == 'individual' ? 'checked' : ''); ?>>
                    ...
                    <div class="form-check p-3 border rounded" style="cursor: pointer;">
                        <input class="form-check-input" type="radio" name="data_source" value="third_party" id="src-third"
                               <?php echo e(($submission->data_source ?? '') == 'third_party' ? 'checked' : ''); ?>>
            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <textarea name="data_update_method" class="form-control" rows="6"
                              placeholder="Example: Data is updated annually during registration through the self-service portal. Staff must submit change requests within 30 days of any change. Verification is done through official documentation."><?php echo e(old('data_update_method', $submission->data_update_method)); ?></textarea>
...
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/ropa/steps/step5.blade.php ENDPATH**/ ?>