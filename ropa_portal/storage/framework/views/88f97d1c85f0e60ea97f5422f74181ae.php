        ...
        <div class="auth-card">
            ...
            <div class="form-container">
                ...
                <div id="loginForm" class="form-pane">
                    <form method="POST" action="<?php echo e(route('login')); ?>" id="loginFormElement">
                        <?php echo csrf_field(); ?>
                ...
                <div id="signupForm" class="form-pane" style="display: none;">
                    <form method="POST" action="<?php echo e(route('register')); ?>" id="signupFormElement">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/auth/login.blade.php ENDPATH**/ ?>