                ...
                <div class="card-body">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="url" name="consent_link" class="form-control"
                               value="<?php echo e(old('consent_link', $submission->consent_link)); ?>"
                               placeholder="https://...">
                    </div>
            ...
            <div class="card h-100 border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <textarea name="data_location" class="form-control" rows="5"
                              placeholder="Example: 'Primary storage: University shared drive (G:\HR\Personnel Records). Cloud backup: Microsoft SharePoint with EU data residency. On-premise database: Oracle server in Data Center Room 204.'"><?php echo e(old('data_location', $submission->data_location)); ?></textarea>
...
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/ropa/steps/step11.blade.php ENDPATH**/ ?>