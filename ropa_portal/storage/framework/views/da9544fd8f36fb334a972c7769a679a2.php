        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor:pointer;">
                                <input class="form-check-input" type="radio" name="dpia_required" value="1" id="dpia-yes"
                                    <?php echo e($dpiaRequired === '1' ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor:pointer;">
                                <input class="form-check-input" type="radio" name="dpia_required" value="0" id="dpia-no"
                                    <?php echo e($dpiaRequired === '0' ? 'checked' : ''); ?>>
                    ...
                    <div id="dpia-section"
                        class="mt-4"
                        style="display: <?php echo e($dpiaRequired === '1' ? 'block' : 'none'); ?>;">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="dpia_progress" class="form-select" id="dpia_progress">
                                    <option value="not_started" <?php echo e(old('dpia_progress', $submission->dpia_progress) == 'not_started' ? 'selected' : ''); ?>>
                                        ⚪ Not Started
                                    </option>
                                    <option value="in_progress" <?php echo e(old('dpia_progress', $submission->dpia_progress) == 'in_progress' ? 'selected' : ''); ?>>
                                        🟡 In Progress
                                    </option>
                                    <option value="completed" <?php echo e(old('dpia_progress', $submission->dpia_progress) == 'completed' ? 'selected' : ''); ?>>
                                        🟢 Completed
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="mt-4 p-3 rounded border" id="risk-indicator" style="background: #f8f9fa;">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                    ...
                                    ?>
                                    <span class="badge <?php echo e($risk['class']); ?>" style="padding: 8px 16px;">
                                        <i class="fas fa-<?php echo e($risk['icon']); ?> me-1"></i>
                                        <?php echo e($risk['level']); ?>
