        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor: pointer;" onclick="document.getElementById('dpia-yes').click()">
                                <input class="form-check-input" type="radio" name="dpia_required" value="1" id="dpia-yes"
                                       <?php echo e($submission->dpia_required === true ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            <div class="form-check mb-3 p-3 border rounded" style="cursor: pointer;" onclick="document.getElementById('dpia-no').click()">
                                <input class="form-check-input" type="radio" name="dpia_required" value="0" id="dpia-no"
                                       <?php echo e($submission->dpia_required === false ? 'checked' : ''); ?>>
                    ...
                    <div id="dpia-section" class="mt-4 <?php echo e($submission->dpia_required !== true ? 'd-none' : ''); ?>">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select name="dpia_progress" class="form-select" id="dpia_progress">
                                    <option value="not_started" <?php echo e($submission->dpia_progress == 'not_started' ? 'selected' : ''); ?>>
                                        ⚪ Not Started
                                    </option>
                                    <option value="in_progress" <?php echo e($submission->dpia_progress == 'in_progress' ? 'selected' : ''); ?>>
                                        🟡 In Progress
                                    </option>
                                    <option value="completed" <?php echo e($submission->dpia_progress == 'completed' ? 'selected' : ''); ?>>
                                        🟢 Completed
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="url" name="dpia_link" class="form-control"
                                           value="<?php echo e(old('dpia_link', $submission->dpia_link)); ?>"
                        ...
                        <div class="mt-4 p-3 rounded" id="risk-indicator" style="background: #f8f9fa;">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div>
                                     ...
                                     ?>
                                     <span class="badge <?php echo e($riskClass); ?>" style="padding: 8px 16px;">
                                         <i class="fas fa-<?php echo e($submission->dpia_progress == 'completed' ? 'check' : ($submission->dpia_progress == 'in_progress' ? 'clock' : 'exclamation')); ?> me-1"></i>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Clement Aryee\Documents\UG Projects\UG_ROPA_Form_Portal\ropa_portal\resources\views/ropa/steps/step12.blade.php ENDPATH**/ ?>