<div class="form-section">
    ...
    <div class="card border-0 shadow-sm " id="joint-controllers-section" style="display: {{ $jointController === '1' ? 'block' : 'none' }};">
        <div class="card-body">
